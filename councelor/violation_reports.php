...
<body class="bg-gray-100">
    <div class="container mx-auto px-4 py-8">
        <h1 class="text-3xl font-bold mb-8">Violation Reports</h1>
        <div class="bg-white p-6 rounded-lg shadow-md">
            <h2 class="text-xl font-semibold mb-4">All Violation Reports</h2>
            <?php if (empty($reports)): ?>
                <p class="text-gray-600">No violation reports found.</p>
            <?php else: ?>
                <table class="w-full">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <?php foreach ($reports as $report): ?>
                            <tr>
                                ...
                                <td class="py-2">
                                    <a href="violation_details.php?id=<?php echo $report['id']; ?>"
